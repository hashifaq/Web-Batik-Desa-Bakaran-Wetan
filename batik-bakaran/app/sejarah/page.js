...
export default function Sejarah() {
    ...
    return (
        <div className="relative min-h-screen">
            <div 
                className="absolute inset-0 bg-center bg-cover z-0 parallax-bg" // Tambahkan kelas parallax-bg di sini
            ...
            <div className="relative z-20 flex flex-col min-h-screen">
                ...
                <div 
                    className="flex flex-col lg:flex-row justify-center items-center w-full bg-darkbrown py-12 px-10 lg:px-44 gap-8 lg:gap-20" 
                    data-aos="fade-up" 
                >
                    <div>
                        <img
                        ...
                        />
                        <p 
                            className="text-white font-poppins text-xs text-center mt-2" 
                        >
                            Desa Bakaran Wetan, src detik.com
                        </p>
                    </div>
                    <div 
                        className="flex text-white font-poppins lg:text-lg text-sm leading-loose text-justify" 
                        style={{ lineHeight: "2" }}
                        data-aos="fade-up" 
                    >
                ...
                <div 
                    className="text-black font-poppins text-sm lg:text-xl leading-loose text-justify py-12 px-10 lg:px-44" 
                    style={{ lineHeight: "2" }}
                    data-aos="fade-up" 
                >
                ...
                <div 
                    className="text-black font-poppins text-sm lg:text-xl leading-loose text-justify px-10 lg:px-44 mb-14" 
                    style={{ lineHeight: "2" }}
                    data-aos="fade-up" 
                >
                ...
                >
                    ...
                    />
                    <p 
                        className="text-darkbrown font-poppins text-xs text-center mt-2"
                        data-aos="fade-up" 
                    >
                ...
                <div 
                    className="text-black font-poppins text-sm lg:text-xl leading-loose text-justify px-10 lg:px-44 mb-16" 
                    style={{ lineHeight: "2" }}
                    data-aos="fade-up" 
                >
                ...
                <div 
                    className="flex flex-col-reverse lg:flex-row justify-center items-center w-full bg-darkbrown py-12 px-10 lg:px-44 gap-8 lg:gap-20"
                    data-aos="fade-up" 
                >
                    <div 
                        className="flex text-white font-poppins text-sm lg:text-xl leading-loose text-justify" 
                        style={{ lineHeight: "2" }}
                        data-aos="fade-up" 
                    >
                ...
                <div 
                    className="text-black font-poppins text-sm lg:text-xl leading-loose text-justify px-10 lg:px-44 mt-16 mb-16" 
                    style={{ lineHeight: "2" }}
                    data-aos="fade-up" 
                >
