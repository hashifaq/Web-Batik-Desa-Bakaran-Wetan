export default function MotifCard({ imgSrc, title, filosofi, harapan, ...props }) {
    return (
        <div
            className="bg-white p-4 w-full max-w-lg min-h-[400px] md:min-h-[430px] lg:min-h-[510px] mx-auto text-darkbrown"
            {...props}  
        >
